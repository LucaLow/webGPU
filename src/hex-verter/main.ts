...
const conversion_button: HTMLElement = document.getElementById("convert-button");
const binary_step: HTMLElement = document.getElementById("binary-raw");
const grouped_binary_step: HTMLElement = document.getElementById("binary-grouped");
const grouped_hex_step: HTMLElement = document.getElementById("hexadecimal-grouped");
const hex_output: HTMLElement = document.getElementById("hexadecimal");
